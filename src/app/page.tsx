            ...
            <div className="col-span-4 sm:col-span-3">
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-xl font-bold">Mahalthy Khaleel Ahmed</h1>
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            <span className="text-gray-700 font-bold">Lead Software Engineer</span>
                            <p>
                                <span className="text-gray-700 mr-2">at TAO Digital Solutions Limited </span>
                                <span className="text-gray-700">2024 - till date</span>
                            </p>
                        </div>
                        <p className="mt-2">
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            <span className="text-gray-700 font-bold">	Principal Engineer II </span>
                            <p>
                                <span className="text-gray-700 mr-2">at Bhavna Corp. (Bhavna Software India Pvt. Ltd.)</span>
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            <span className="text-gray-700 font-bold">	Sr. Software Engineer </span>
                            <p>
                                <span className="text-gray-700 mr-2">at Delta Technology and Management Services Private Ltd</span>
                                <span className="text-gray-700">2019 - 2021</span>
                            </p>
                        </div>
                        <p className="mt-2">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus est vitae
